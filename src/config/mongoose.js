...
module.exports.connection = function (cb) {
    var MONGODB_URI = process.env.MONGO_DB_URI || process.env.MONGODB_URI || process.env.MONGODB_URI_TEST || "mongodb+srv://crmapp:H25CGRZh4fbTUQq@cluster0.scve4.mongodb.net/crmtest?retryWrites=true&w=majority"
